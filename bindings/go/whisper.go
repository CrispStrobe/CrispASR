...
#cgo linux LDFLAGS: -Wl,--start-group -lcrispasr -lparakeet -lcanary -lcanary_ctc -lqwen3_asr -lcrisp_audio -lcohere -lgranite_speech -lvoxtral -lvoxtral4b -lwav2vec2-ggml -lglm-asr -lkyutai-stt -lfirered-asr -lfirered-vad -lmarblenet-vad -lcrispasr-vad-encdec -lfirered-lid -lomniasr -lvibevoice -lecapa-lid -lmoonshine -lmoonshine_streaming -lgemma4_e2b -lmimo_tokenizer -lmimo_asr -lqwen3_tts -lorpheus -lkokoro -lchatterbox -lm2m100 -lfireredpunc -lpyannote-seg -lsilero-lid -lcrispasr-core -lggml -lggml-base -lggml-cpu -Wl,--end-group -lm -lstdc++ -fopenmp
#cgo darwin LDFLAGS: -lcrispasr -lparakeet -lcanary -lcanary_ctc -lqwen3_asr -lcrisp_audio -lcohere -lgranite_speech -lvoxtral -lvoxtral4b -lwav2vec2-ggml -lglm-asr -lkyutai-stt -lfirered-asr -lfirered-vad -lmarblenet-vad -lcrispasr-vad-encdec -lfirered-lid -lomniasr -lvibevoice -lecapa-lid -lmoonshine -lmoonshine_streaming -lgemma4_e2b -lmimo_tokenizer -lmimo_asr -lqwen3_tts -lorpheus -lkokoro -lchatterbox -lm2m100 -lfireredpunc -lpyannote-seg -lsilero-lid -lcrispasr-core -lggml -lggml-base -lggml-cpu -lm -lstdc++
