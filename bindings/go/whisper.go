...
#cgo linux LDFLAGS: -Wl,--start-group -lggml-base -lggml-cpu -lggml -lwav2vec2-ggml -lcrispasr-core -ltada-encoder -ltada-codec -lcrisp_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lopus -logg -lzonos-tts -lwebrtc-vad -lvoxtral_tts -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsidon -lsensevoice -lqwen3_tts -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomnivoice -lomniasr -lnemotron -lmoss_tts_local -lmoss_tts -lmoss_transcribe_diarize -lmoss_transcribe -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmel-band-roformer -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lirodori-tts -lindextts -lhtdemucs -lhiggs_stt -lgranite_speech -lgranite_nle -lglm-asr -lglint -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldots-tts -ldia-tts -lctc-align -lcsm-tts -lcrispasr_opusfile -lcrispasr_c2pa_native -lcrispasr-vad-encdec -lcrispasr-llama-core -lcrisp_truecase -lcrisp_punc -lcrisp_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_qwen -lcanary_ctc -lcanary -lbark-tts -lbananamind-tts -laudioseal -lark_asr -lcrispasr -Wl,--end-group -lm -lstdc++ -fopenmp
#cgo darwin LDFLAGS: -lggml-base -lggml-cpu -lggml -lwav2vec2-ggml -lcrispasr-core -ltada-encoder -ltada-codec -lcrisp_audio -lsnac -lmoonshine_tokenizer -lmimo_tokenizer -lbert-encoder -lfirered-asr -lopus -logg -lzonos-tts -lwebrtc-vad -lvoxtral_tts -lvoxtral4b -lvoxtral -lvoxcpm2_tts -lvibevoice -ltitanet -ltada-tts -lt5_translate -lspeecht5-tts -lsilero-lid -lsidon -lsensevoice -lqwen3_tts -lqwen3_asr -lpyannote-seg -lpocket-tts -lpiper-tts -lparler-tts -lparakeet -lparaformer -loutetts -lorpheus -lopenvoice2 -lomnivoice -lomniasr -lnemotron -lmoss_tts_local -lmoss_tts -lmoss_transcribe_diarize -lmoss_transcribe -lmoss_audio -lmoonshine_streaming -lmoonshine -lmini-omni2 -lmimo_asr -lmelotts -lmel-band-roformer -lmarblenet-vad -lm2m100 -llfm2_audio -lkyutai-stt -lkugelaudio -lkokoro -lirodori-tts -lindextts -lhtdemucs -lhiggs_stt -lgranite_speech -lgranite_nle -lglm-asr -lglint -lgemma4_e2b -lfunasr -lfirered-vad -lfirered-lid -lfastpitch-tts -lf5-tts -lecapa-lid -ldots-tts -ldia-tts -lctc-align -lcsm-tts -lcrispasr_opusfile -lcrispasr_c2pa_native -lcrispasr-vad-encdec -lcrispasr-llama-core -lcrisp_truecase -lcrisp_punc -lcrisp_lid -lcosyvoice3_tts -lcohere -lchatterbox -lcanary_qwen -lcanary_ctc -lcanary -lbark-tts -lbananamind-tts -laudioseal -lark_asr -lcrispasr -lm -lstdc++
