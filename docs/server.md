...
| `duration` | `0` | Exact output length in seconds, `0 .. 600` (omnivoice; upstream `duration` parity). `0` = the backend's estimate. Out-of-range returns 400 with `code=invalid_duration`. |
