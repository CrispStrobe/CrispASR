...
| `CRISPASR_RNNT_GPU_ENC_PROJ` | `0` restores Parakeet's scalar CPU encoder-to-joint projection. The backend projection is default when its TDT/RNNT decoder runs on a GPU. |
