...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-tiny-uk`](https://huggingface.co/UsefulSensors/moonshine-tiny-uk) for use with **[CrispStrobe/CrispASR](https://github.com/CrispStrobe/CrispASR)**.
...
# Explicit model path
./build/bin/crispasr --backend moonshine -m moonshine-tiny-uk-q4_k.gguf -f audio.wav
```
