...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-tiny-ja`](https://huggingface.co/UsefulSensors/moonshine-tiny-ja) for use with **[CrispStrobe/CrispASR](https://github.com/CrispStrobe/CrispASR)**.
...
# Explicit model path
./build/bin/crispasr --backend moonshine -m moonshine-tiny-ja-q4_k.gguf -f audio.wav
```
